...
#include "unity/unity_output_Spy.h"
#include <stdlib.h>
#include <string.h>
...
static char *noOptions[] = {"testrunner.exe"};
...
static char *verbose[] = {"testrunner.exe", "-v"};
...
static char *group[] = {"testrunner.exe", "-g", "groupname"};
...
static char *name[] = {"testrunner.exe", "-n", "testname"};
...
static char *repeat[] = {"testrunner.exe", "-r", "99"};
...
static char *multiple[] = {"testrunner.exe", "-v", "-g", "groupname", "-n", "testname", "-r", "98"};
