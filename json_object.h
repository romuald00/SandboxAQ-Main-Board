...
#define json_object_object_foreach(obj, key, val)                                                                      \
    ...
    for (struct lh_entry *entry##key = lh_table_head(json_object_get_object(obj)), *entry_next##key = NULL; ({         \
             if (entry##key) {                                                                                         \
 ...
 */
typedef int(json_c_shallow_copy_fn)(
...
JSON_EXPORT int
json_object_deep_copy(struct json_object *src, struct json_object **dst, json_c_shallow_copy_fn *shallow_copy);
#ifdef __cplusplus
}
#endif
